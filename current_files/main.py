...
def load_model():
    ...
    # Optionally try loading state_dict if needed, else skip:
    # If you must load, uncomment:
    # state_dict = torch.load('./checkpoints/jepa_model_epoch_final.pth', map_location='cpu')
