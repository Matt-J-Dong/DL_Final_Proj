...
def load_model(checkpoint_path="./checkpoints_wandb"):
    ...
    # Updated pattern to match 'f' naming
    pattern = "jepa_model_f_epoch_*_lr_*_do_*_cov_*_probe_*.pth"
    ...
    model = JEPA_Model(device=device, repr_dim=256, action_dim=2, dropout=0.0)
