...
from models_md_v5 import Prober, build_mlp
...
class ProbingEvaluator:
    def __init__(
        ...
        # Only change related to lr:
        if hasattr(wandb.config, "probe_lr"):
            self.config.lr = wandb.config.probe_lr
